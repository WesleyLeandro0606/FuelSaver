...
public class MainActivity extends AppCompatActivity {
    EditText edtNomeVeiculo, edtPlaca, edtDistancia, edtConsumo, edtPreco;
    Button btnCalcular;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        btnCalcular.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                double distancia, consumo, resultado, preco, combustivel, custo;
                String nomeVeiculo, placa;

                if (edtNomeVeiculo.getText().toString().isEmpty() ||
                ...
                nomeVeiculo = edtNomeVeiculo.getText().toString();
                ...
                txtResultado.setText(
                        "Veículo: " + nomeVeiculo + "\n" +
                                ...
                                "Combustível: " + Math.round(combustivel) + " L\n" +
                                "Custo: R$ " + Math.round(custo)
